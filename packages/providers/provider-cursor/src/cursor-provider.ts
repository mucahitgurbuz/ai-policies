...
export function renderCursorRules(
  ...
  if (options.includeAttribution) {
    ...
    output += 'This file was automatically generated from the following policy packages:\n\n';
    output += packageList;
 ...
 */
export function validateCursorRules(content: string): { valid: boolean; errors: string[] } {
  const errors: string[] = [];
